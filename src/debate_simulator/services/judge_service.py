...
class JudgeService:
    ...
    def observe_round(
        self, round_number: int, pro_argument: str, con_argument: str, debate_history: list[str] | None = None,
    ) -> Any:
        """Delegate round observation to the judge agent."""
        return self.judge_agent.observe_round(round_number, pro_argument, con_argument, debate_history)
